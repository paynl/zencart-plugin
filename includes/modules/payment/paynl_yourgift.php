...
class paynl_yourgift extends paynl
{
    function __construct()
    {
        parent::__construct(
            ...
            defined('MODULE_PAYMENT_PAYNL_YOURGIFT_ORDER_STATUS_ID') && ((int)MODULE_PAYMENT_PAYNL_YOURGIFT_ORDER_STATUS_ID > 0) ? (int)MODULE_PAYMENT_PAYNL_YOURGIFT_ORDER_STATUS_ID : 0,
