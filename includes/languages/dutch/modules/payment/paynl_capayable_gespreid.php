...
define('MODULE_PAYMENT_PAYNL_CAPAYABLE_GESPREID_TEXT_RETURN_BUTTON', 'Terug naar ' . STORE_NAME);
define('MODULE_PAYMENT_PAYNL_CAPAYABLE_GESPREID_ERROR_TITLE', 'Er is een probleem opgetreden met het doorvoeren van de betaling');
define('MODULE_PAYMENT_PAYNL_CAPAYABLE_GESPREID_ERROR_GENERAL', 'Probeer het a.u.b. nog een keer. Als dit het probleem niet verhelpt, kies een andere betaalmethode.');